...
<html>
    ...
    <body>
        ...
        <div id="show-examType" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.examType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.examType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
